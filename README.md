...
```
docker pull angelics/unraid-docker-ravencoin-wallet
...
```
docker exec RavencoinWalletGUI tail -f /storage/.raven/debug.log
docker exec RavencoinWalletGUI sh /check_status.sh
